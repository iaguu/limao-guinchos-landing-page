...
if($ismobile == false){
    if($route == null){
        ...
        if($route == 'sobre'){
            include('src/desktop/screens/about.php');
        }
        if($route == 'produto'){
        ...
        if($route == 'auth'){
            include('src/painel/auth.php');
        }
        if($route == 'painel-administrativo'){
            include('src/painel/logged/index.php');
        }
    }
}else{
    if($route == null){
        include('src/mobile/screens/inicio.php');
    }else{
        if($route == 'politicas'){
            include('src/mobile/screens/policys.php');
        }
        if($route == 'sobre'){
            include('src/mobile/screens/about.php');
        }
        if($route == 'produto'){
            include('src/mobile/screens/product-details.php');
        }
        if($route == 'categorias'){
            include('src/mobile/screens/categorys.php');
        }
        if($route == 'carrinho'){
            include('src/mobile/screens/carrinho.php');
        }
        if($route == 'purchase-status'){
            include('src/desktop/screens/purchase.php');
        }        
